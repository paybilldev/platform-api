...
const BaseSSOProviderSchema = z.object({
  ...
  join_org_on_signup_role: z
    .enum(['Administrator', 'Developer', 'Owner', 'Read-only'])
    .optional(),
...
const OrganizationSlugResponseSchema = z.object({
  ...
  restriction_status: z
    .enum(['grace_period', 'grace_period_over', 'restricted'])
    .nullable(),
...
export const OrganizationResponseJsonSchema = zodToJsonSchema(
...
export type OrganizationSlugResponse = z.infer<
  typeof OrganizationSlugResponseSchema
>;

export const OrganizationSlugResponseJsonSchema = zodToJsonSchema(
  OrganizationSlugResponseSchema,
  {
...
export const AuditLogsResponseJsonSchema = zodToJsonSchema(
...
export const OrganizationSlugAvailableVersionsResponseJsonSchema =
  zodToJsonSchema(OrganizationSlugAvailableVersionsResponseSchema, {
    name: 'OrganizationSlugAvailableVersionsResponse',
  });

export type CreditsTopUpRequest = z.infer<typeof CreditsTopUpRequestSchema>;

export const CreditsTopUpRequestJsonSchema = zodToJsonSchema(
  CreditsTopUpRequestSchema,
  {
...
export const CreditsTopUpResponseJsonSchema = zodToJsonSchema(
  CreditsTopUpResponseSchema,
  {
...
export type InvoicePaymentLinkResponse = z.infer<
  typeof InvoicePaymentLinkResponseSchema
>;
...
export const UpcomingInvoiceJsonSchema = zodToJsonSchema(
...
export const GetSubscriptionResponseJsonSchema = zodToJsonSchema(
...
export const UpdateSubscriptionBodyJsonSchema = zodToJsonSchema(
...
export type ConfirmSubscriptionChangeBody = z.infer<
  typeof ConfirmSubscriptionChangeBodySchema
>;
...
export type PendingConfirmationResponse = z.infer<
  typeof PendingConfirmationResponseSchema
>;
...
export type BillingCustomerUpdateBody = z.infer<
  typeof BillingCustomerUpdateBodySchema
>;
...
export const CustomerResponseJsonSchema = zodToJsonSchema(
...
export type CreateDpaDocumentRequest = z.infer<
  typeof CreateDpaDocumentRequestSchema
>;

export const CreateDpaDocumentRequestJsonSchema = zodToJsonSchema(
  CreateDpaDocumentRequestSchema,
  {
    name: 'CreateDpaDocumentRequest',
  },
);

export type CreateDpaDocumentResponse = z.infer<
  typeof CreateDpaDocumentResponseSchema
>;
...
export type OrgDocumentUrlResponse = z.infer<
  typeof OrgDocumentUrlResponseSchema
>;

export const OrgDocumentUrlResponseJsonSchema = zodToJsonSchema(
  OrgDocumentUrlResponseSchema,
  {
...
export const ListEntitlementsResponseJsonSchema = zodToJsonSchema(
...
export const AssignMemberRoleBodyJsonSchema = zodToJsonSchema(
  AssignMemberRoleBodySchema,
  {
...
export const UpdateMemberRoleBodyJsonSchema = zodToJsonSchema(
...
export const CreateInvitationBodyJsonSchema = zodToJsonSchema(
...
export const InvitationResponseJsonSchema = zodToJsonSchema(
...
export type InvitationByTokenResponse = z.infer<
  typeof InvitationByTokenResponseSchema
>;
...
export const MfaStatusResponseJsonSchema = zodToJsonSchema(
...
export type MemberWithFreeProjectLimit = z.infer<
  typeof MemberWithFreeProjectLimitSchema
>;
...
export const OAuthAppResponseJsonSchema = zodToJsonSchema(
...
export const CreateOAuthAppBodyJsonSchema = zodToJsonSchema(
  CreateOAuthAppBodySchema,
  {
...
export const OAuthAppResponseListJsonSchema = zodToJsonSchema(
  OAuthAppResponseListSchema,
  {
    name: 'OAuthAppResponse',
  },
);
...
export const PutOAuthAppResponseJsonSchema = zodToJsonSchema(
  PutOAuthAppResponseSchema,
  {
    name: 'PutOAuthAppResponse',
  },
);

export type DeleteOAuthAppResponse = z.infer<
  typeof DeleteOAuthAppResponseSchema
>;

export const DeleteOAuthAppResponseJsonSchema = zodToJsonSchema(
  DeleteOAuthAppResponseSchema,
  {
...
export type ApproveAuthorizationResponse = z.infer<
  typeof ApproveAuthorizationResponseSchema
>;
...
export type DeclineAuthorizationResponse = z.infer<
  typeof DeclineAuthorizationResponseSchema
>;
...
export const PaymentsResponseJsonSchema = zodToJsonSchema(
...
export type DetachPaymentMethodBody = z.infer<
  typeof DetachPaymentMethodBodySchema
>;

export const DetachPaymentMethodBodyJsonSchema = zodToJsonSchema(
  DetachPaymentMethodBodySchema,
  {
    name: 'DetachPaymentMethodBody',
  },
);

export type MarkDefaultPaymentMethodBody = z.infer<
  typeof MarkDefaultPaymentMethodBodySchema
>;
...
export type OrganizationProjectsResponse = z.infer<
  typeof OrganizationProjectsResponseSchema
>;
...
export type OrganizationRoleResponse = z.infer<
  typeof OrganizationRoleResponseSchema
>;

export const OrganizationRoleResponseJsonSchema = zodToJsonSchema(
...
export const GetSSOProviderResponseJsonSchema = zodToJsonSchema(
  SSOProviderSchema,
  {
    name: 'GetSSOProviderResponse',
  },
);
export const UpdateSSOProviderBodyJsonSchema = zodToJsonSchema(
  SSOProviderSchema,
  {
    name: 'UpdateSSOProviderBody',
  },
);
export const UpdateSSOProviderResponseJsonSchema = zodToJsonSchema(
  SSOProviderSchema,
  {
    name: 'UpdateSSOProviderResponse',
  },
);
export const CreateSSOProviderBodyJsonSchema = zodToJsonSchema(
  SSOProviderSchema,
  {
    name: 'CreateSSOProviderBody',
  },
);
export const CreateSSOProviderResponseJsonSchema = zodToJsonSchema(
  SSOProviderSchema,
  {
...
export const CreateTaxIdBodyJsonSchema = zodToJsonSchema(
  CreateTaxIdBodySchema,
  {
...
export const OrgUsageResponseJsonSchema = zodToJsonSchema(
...
export const OrgDailyUsageResponseJsonSchema = zodToJsonSchema(
  OrgDailyUsageResponseSchema,
  {
    name: 'OrgDailyUsageResponse',
  },
);

export type CreateAwsBilledOrganizationBody = z.infer<
  typeof CreateAwsBilledOrganizationBodySchema
>;
...
export const RequestUpgradeBodyJsonSchema = zodToJsonSchema(
  RequestUpgradeBodySchema,
  {
...
export type RequestUpgradeResponse = z.infer<
  typeof RequestUpgradeResponseSchema
>;

export const RequestUpgradeResponseJsonSchema = zodToJsonSchema(
  RequestUpgradeResponseSchema,
  {
