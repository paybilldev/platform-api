...
export const SendDocsFeedbackBodyJsonSchema = zodToJsonSchema(
  SendDocsFeedbackBodySchema,
  {
...
export const SendFeedbackResponseJsonSchema = zodToJsonSchema(
...
export const SendExitSurveyBodyJsonSchema = zodToJsonSchema(
  SendExitSurveyBodySchema,
  {
...
export const SendFeedbackBodyJsonSchema = zodToJsonSchema(
...
export const SendUpgradeSurveyBodyJsonSchema = zodToJsonSchema(
  SendUpgradeSurveyBodySchema,
  {
