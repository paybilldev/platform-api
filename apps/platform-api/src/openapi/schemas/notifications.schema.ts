...
export const NotificationResponseJsonSchema = zodToJsonSchema(
...
export type UpdateNotificationBody = z.infer<
  typeof UpdateNotificationBodySchema
>;

export const UpdateNotificationBodyJsonSchema = zodToJsonSchema(
...
export const NotificationsSummaryJsonSchema = zodToJsonSchema(
