...
export const BackupsResponseJsonSchema = zodToJsonSchema(
...
export const DownloadBackupBodyJsonSchema = zodToJsonSchema(
  DownloadBackupBodySchema,
  {
    name: 'DownloadBackupBody',
  },
);

export type DownloadBackupResponse = z.infer<
  typeof DownloadBackupResponseSchema
>;

export const DownloadBackupResponseJsonSchema = zodToJsonSchema(
  DownloadBackupResponseSchema,
  {
    name: 'DownloadBackupResponse',
  },
);

export type DownloadableBackupsResponse = z.infer<
  typeof DownloadableBackupsResponseSchema
>;
...
export type PointInTimeRestoreBody = z.infer<
  typeof PointInTimeRestoreBodySchema
>;

export const PointInTimeRestoreBodyJsonSchema = zodToJsonSchema(
  PointInTimeRestoreBodySchema,
  {
    name: 'PointInTimeRestoreBody',
  },
);

export type RestoreLogicalBackupBody = z.infer<
  typeof RestoreLogicalBackupBodySchema
>;

export const RestoreLogicalBackupBodyJsonSchema = zodToJsonSchema(
  RestoreLogicalBackupBodySchema,
  {
    name: 'RestoreLogicalBackupBody',
  },
);

export type RestorePhysicalBackupBody = z.infer<
  typeof RestorePhysicalBackupBodySchema
>;
...
export const CloneBackupsResponseJsonSchema = zodToJsonSchema(
  CloneBackupsResponseSchema,
  {
...
export const ProjectClonedResponseJsonSchema = zodToJsonSchema(
  ProjectClonedResponseSchema,
  {
    name: 'ProjectClonedResponse',
  },
);

export type ProjectClonedStatusResponse = z.infer<
  typeof ProjectClonedStatusResponseSchema
>;
