...
export const OverdueInvoiceCountJsonSchema = zodToJsonSchema(
  OverdueInvoiceCountSchema,
  {
...
export const SetupIntentRequestJsonSchema = zodToJsonSchema(
...
export const SetupIntentResponseJsonSchema = zodToJsonSchema(
