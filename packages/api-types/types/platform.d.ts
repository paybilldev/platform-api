...
export interface paths {
  '/platform/auth/{ref}/config': {
    ...
    get: operations['AuthConfigController_getAuthConfig']
    put?: never
    post?: never
    delete?: never
    options?: never
    ...
    patch: operations['AuthConfigController_updateAuthConfig']
    trace?: never
  }
  '/platform/auth/{ref}/config/hooks': {
    ...
    patch: operations['AuthConfigController_updateAuthConfigHooks']
    trace?: never
  }
  ...
  '/platform/integrations/github/authorization': {
    ...
    put?: never
    /** @description Upsert GitHub authorization. Creates or updates a GitHub authorization for the current user */
    post: operations['GitHubAuthorizationsController_createGitHubAuthorization']
    /** @description Remove GitHub authorization. Removes the GitHub authorization for the current user */
  ...
  '/platform/integrations/github/repositories/{repository_id}/branches/{branch_name}': {
    ...
    /** @description Get GitHub repository branch. This is a temporary endpoint before dashboard switches to combo box */
  ...
  '/platform/integrations/private-link/{slug}': {
    ...
    post: operations['PrivateLinkController_updatePrivateLinkConfig']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/platform/organizations/{slug}/available-versions': {
    ...
    get?: never
    put?: never
    /** @description Retrieves a list of available Database versions available to the organization */
  ...
  '/platform/organizations/{slug}/members/{user_id}': {
    ...
    patch: operations['MembersController_assignMemberRole']
    trace?: never
  }
  ...
  '/platform/projects/': {
    ...
    /** @description Gets all projects that belong to the authenticated user. Only returns the minimal project info. */
  ...
  '/platform/projects/projects-resource-warnings': {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /** @description Gets resource warnings for all projects accessible by the user. Only returns the minimal project info. */
  ...
  '/platform/stripe/invoices/overdue': {
    ...
    /** @description Gets information about overdue invoices that relate to the authenticated user */
...
export interface components {
  schemas: {
    ...
    OrganizationSlugAvailableVersionsResponse: {
      available_versions: {
        /** @enum {string} */
        database_engine: '15-postgres' | '17-postgres' | '17-postgres-oriole'
        /** @enum {string} */
        release_channel: 'internal' | 'alpha' | 'beta' | 'ga' | 'withdrawn' | 'preview'
        version: string
      }[]
...
export interface operations {
  AuthConfigController_getAuthConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
  ...
  AuthConfigController_updateAuthConfig: {
    parameters: {
      query?: never
      header?: never
      path: {
  ...
  AuthConfigController_updateAuthConfigHooks: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody?: {
      content: {
        'application/json': components['schemas']['UpdateAuthConfigHooksBody']
      }
    }
    responses: {
      /** @description Default Response */
  ...
  MembersController_assignMemberRole: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody?: {
      content: {
        'application/json': components['schemas']['AssignMemberRoleBody']
      }
    }
    responses: {
      /** @description Default Response */
  ...
  OAuthAppsController_listOAuthApps: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['OAuthAppResponseList']
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  PaymentsController_markPaymentMethodAsDefault: {
    ...
    responses: {
      /** @description Payment method marked as default */
      200: {
        headers: {
          [name: string]: unknown
        }
  ...
  TaxIdsController_getTaxId: {
    ...
    responses: {
      ...
      /** @description Failed to retrieve tax ID */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  TaxIdsController_updateTaxId: {
    ...
    responses: {
      ...
      /** @description Failed to create/update tax ID */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  TaxIdsController_deleteTaxId: {
    ...
    responses: {
      ...
      /** @description Failed to delete tax ID */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  StorageObjectsController_getObjects: {
    ...
    responses: {
      ...
      /** @description Failed to get list of objects */
      500: {
        headers: {
          [name: string]: unknown
        }
  ...
  StorageVectorBucketIdIndexesController_deleteBucketIndex: {
    ...
    requestBody?: never
    responses: {
      /** @description Bucket index deleted successfully */
      200: {
        headers: {
          [name: string]: unknown
        }
  ...
  TelemetryFeatureFlagsController_trackFeatureFlag: {
    ...
    responses: {
      /** @description Feature flag tracked */
      201: {
        headers: {
          [name: string]: unknown
        }
  ...
  TelemetryIdentifyController_identify: {
    ...
    responses: {
      /** @description Group identify event sent */
      201: {
        headers: {
          [name: string]: unknown
        }
  ...
  TelemetryGroupsController_groupReset: {
    ...
    responses: {
      /** @description Group reset event sent */
      201: {
        headers: {
          [name: string]: unknown
        }
  ...
  TelemetryIdentifyController_identify: {
    ...
    responses: {
      /** @description Identify event sent */
      201: {
        headers: {
          [name: string]: unknown
        }
